...
mkdir /etc/systemd/system/grafana.service.d/
mkdir /etc/systemd/system/pmcd.service.d/
mv /tmp/files/labs/section-3/service-failures/dependencies/grafana /etc/systemd/system/grafana.service.d/depends.conf
